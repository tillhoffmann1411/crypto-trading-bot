...
def send_email(subject, text):
    send_mail = "tillh1@gmx.de"
    receive_mail = "tillh1@gmx.de"
    msg = MIMEMultipart()
    msg['From'] = send_mail
    msg['To'] = receive_mail
    msg['Subject'] = subject
    ...
    server.starttls()
    server.login(send_mail, os.environ.get('EMAIL_PASSWORD'))
    text = msg.as_string()
...
logging.basicConfig(filemode="w", filename='./logs/%s.log' % log_filename,
